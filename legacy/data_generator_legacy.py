...
IMG_EXT = '.png'
LIDAR_EXT='.ply'
sensor_attributes_dict = {SEN_RGB_LABEL:{'ext':IMG_EXT},SEN_DEPTH_LABEL:{'ext':IMG_EXT},SEN_LIDAR_LABEL:{'ext':LIDAR_EXT}}
    ...
    for f_idx,f in enumerate(recorded_frames):
        for ego_v_id in id_vehicle_with_sensor:
            ...
            for o_pid in observed_v_pid_arr:
                coop_flag = (observed[f_idx, :, o_pid] > 1) * (dist_graph[f_idx,:,o_pid]<50)
